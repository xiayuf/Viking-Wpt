...
// WinLicense functions prototype
 ...
 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseFileKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                                                char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* BufferOut);

 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseFileKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                                                LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, char* BufferOut);
 ...
 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseRegistryKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                                                char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* KeyName, char* KeyValueName, char* BufferOut);

 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseRegistryKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                                                LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, char* KeyName, char* KeyValueName, char* BufferOut);
 ...
 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseTextKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                                                char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* BufferOut);

 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseTextKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                                                LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, char* BufferOut);
 ...
 extern "C" _stdcall __declspec(dllimport) int WLGenLicenseSmartKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                                                LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                char* BufferOut);
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegGetLicenseInfoW(LPCWSTR pName, LPCWSTR pCompanyName, LPCWSTR pCustomData);
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegSmartKeyCheckW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegSmartKeyInstallToFileW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegSmartKeyInstallToRegistryW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 ...
 extern "C" _stdcall __declspec(dllimport) LPCWSTR WLStringDecryptW(LPCWSTR pString);
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegSmartKeyInstallToFileInFolder(char* UserName, char* Organization, char* Custom, char* AsciiKey, char* FilePath);
 ...
 extern "C" int _stdcall WLGenLicenseFileKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                          char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* BufferOut);

 extern "C" int _stdcall WLGenLicenseFileKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                          LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          int CountryId, int Runtime, int GlobalMinutes, char* BufferOut);
 ...
 extern "C" int _stdcall WLGenLicenseRegistryKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                          char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* KeyName, char* KeyValueName, char* BufferOut);

 extern "C" int _stdcall WLGenLicenseRegistryKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                                                LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                                                int CountryId, int Runtime, int GlobalMinutes, char* KeyName, char* KeyValueName, char* BufferOut);
 ...
 extern "C" int _stdcall WLGenLicenseTextKeyEx(char* LicenseHash, char* UserName, char* Organization,\
                          char* CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          int CountryId, int Runtime, int GlobalMinutes, int NetworkInstances, char* BufferOut);

 extern "C" int _stdcall WLGenLicenseTextKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                          LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          int CountryId, int Runtime, int GlobalMinutes, char* BufferOut);
 ...
 extern "C" int _stdcall WLGenLicenseSmartKeyW(char* LicenseHash, LPCWSTR UserName, LPCWSTR Organization,\
                          LPCWSTR CustomData, char* MachineID, int NumDays, int NumExec, SYSTEMTIME* NewDate, \
                          char* BufferOut);
 ...
 extern "C" bool _stdcall WLRegGetLicenseInfoW(LPCWSTR pName, LPCWSTR pCompanyName, LPCWSTR pCustomData);
 ...
 extern "C" bool _stdcall WLRegSmartKeyCheckW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 ...
 extern "C" bool _stdcall WLRegSmartKeyInstallToFileW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 
 extern "C" bool _stdcall WLRegSmartKeyInstallToRegistryW(LPCWSTR UserName, LPCWSTR Organization, LPCWSTR Custom, char* AsciiKey);
 ...
 extern "C" TCHAR* _stdcall WLStringDecryptW(LPCWSTR pString);
 ...
 extern "C" bool _stdcall WLRegSmartKeyInstallToFileInFolder(char* UserName, char* Organization, char* Custom, char* AsciiKey, char* FilePath);
